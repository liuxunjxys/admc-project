...
function init_NowplayingTab (){
	...
	var nowplaying_content_min_height = $('#div_content_nowplaying_tab').height();
	...
	nowplaying_content_perform_minheight = 
		nowplaying_content_min_height - nowplaying_content_info_height - nowplaying_content_controler_height;
	nowplaying_content_perform_minheight += 'px';
	
	nowplaying_content_perform_maxheight = 
		nowplaying_content_max_height- nowplaying_content_info_height - nowplaying_content_controler_height;
