 ...
 * <p>
 * Used when sending messages about local devices and services to other UPnP participants on the network, such as where our device/service descriptors can be
 * found or what callback address to use for event message delivery. We also let them know our MAC hardware address so they can wake us up from sleep with
 * Wake-On-LAN if necessary.
 * </p>
 * 
