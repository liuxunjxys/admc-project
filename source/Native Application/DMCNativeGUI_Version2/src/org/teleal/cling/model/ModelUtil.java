...
public class ModelUtil {
	...
	/**
	 * @param name
	 *            A UPnP device architecture "name" string.
	 * @return <code>true</code> if the name is not empty, doesn't start with "xml", and matches {@link org.teleal.cling.model.Constants#REGEX_UDA_NAME}.
	 */
	...
	/**
	 * @param s
	 *            A string representing hours, minutes, seconds, e.g. <code>11:23:44</code>
	 ...
	 * 
	 * @param includeDomain
	 *            <code>true</code> if the whole FQDN should be returned, instead of just the first (host) part.
