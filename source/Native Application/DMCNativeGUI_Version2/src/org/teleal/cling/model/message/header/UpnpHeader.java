 ...
 * <p>
 * The {@link #newInstance(org.teleal.cling.model.message.header.UpnpHeader.Type, String)} method attempts to instantiate the best header subtype for a given
 * header (name) and string value.
 * </p>
 * 
...
public abstract class UpnpHeader<T> {
	...
	public static enum Type {
		...
		USN("USN", USNRootDeviceHeader.class, DeviceUSNHeader.class, ServiceUSNHeader.class, UDNHeader.class), NT("NT", RootDeviceHeader.class,
				UDADeviceTypeHeader.class, UDAServiceTypeHeader.class, DeviceTypeHeader.class, ServiceTypeHeader.class, UDNHeader.class, NTEventHeader.class), NTS(
				"NTS", NTSHeader.class), HOST("HOST", HostHeader.class), SERVER("SERVER", ServerHeader.class), LOCATION("LOCATION", LocationHeader.class), MAX_AGE(
				"CACHE-CONTROL", MaxAgeHeader.class), USER_AGENT("USER-AGENT", UserAgentHeader.class), CONTENT_TYPE("CONTENT-TYPE", ContentTypeHeader.class), MAN(
				"MAN", MANHeader.class), MX("MX", MXHeader.class), ST("ST", STAllHeader.class, RootDeviceHeader.class, UDADeviceTypeHeader.class,
				UDAServiceTypeHeader.class, DeviceTypeHeader.class, ServiceTypeHeader.class, UDNHeader.class), EXT("EXT", EXTHeader.class), SOAPACTION(
				"SOAPACTION", SoapActionHeader.class), TIMEOUT("TIMEOUT", TimeoutHeader.class), CALLBACK("CALLBACK", CallbackHeader.class), SID("SID",
				SubscriptionIdHeader.class), SEQ("SEQ", EventSequenceHeader.class),
	 ...
	 * <p>
	 * This method iterates through all potential header subtype classes as declared in {@link Type}. It creates a new instance of the subtype class and calls
	 * its {@link #setString(String)} method. If no {@link org.teleal.cling.model.message.header.InvalidHeaderException} is thrown, the subtype instance is
	 * returned.
	 * </p>
	 * 
	 * @param type
	 *            The type (or name) of the header.
	 * @param headerValue
