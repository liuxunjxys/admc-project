...
package com.app.dlna.dmc.gui.actionbar;
...
public class ActionBarHelperBase extends ActionBarHelper {
	 ...
	 * {@link com.coraldevil.stockracker.android.actionbar.example.android.actionbarcompat.ActionBarHelperBase#setRefreshActionItemState(boolean)}
	 * .
	 */
	private View addActionItemCompatFromMenuItem(final MenuItem item) {
		...
		actionButton.setLayoutParams(new ViewGroup.LayoutParams((int) mActivity.getResources().getDimension(
				R.dimen.actionbar_compat_button_home_width), ViewGroup.LayoutParams.FILL_PARENT));
	...
	private class WrappedMenuInflater extends MenuInflater {
		...
		private void loadActionBarMetadata(int menuResId) {
			...
			try {
				...
				throw new InflateException("Erro+r inflating menu XML", e);
			} finally {
				if (parser != null) {
					parser.close();
				}
