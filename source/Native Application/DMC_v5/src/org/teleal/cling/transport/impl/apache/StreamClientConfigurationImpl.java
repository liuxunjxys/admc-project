...
public class StreamClientConfigurationImpl implements StreamClientConfiguration {
	...
	private String contentCharset = "UTF-8"; // UDA spec says it's always UTF-8
												// entity content
	...
	/**
	 * Defaults to the values defined in
	 * {@link org.teleal.cling.model.Constants}.
	 */
	...
	/**
	 * if -1, the default value of HttpClient will be used (8192 in httpclient
	 * 4.1)
	 */
