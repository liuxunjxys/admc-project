 ...
 * <p>
 * This interface offers methods for retrieval of configuration data by the {@link org.teleal.cling.transport.Router} and the
 * {@link org.teleal.cling.registry.Registry}, as well as other parts of the UPnP stack.
 * </p>
 * <p>
...
public interface UpnpServiceConfiguration {
	 ...
	 *            The configured {@link org.teleal.cling.transport.spi.NetworkAddressFactory}.
	 ...
	 * <p>
	 * Return <code>null</code> to completely disable remote device and service discovery. All incoming notifications and search responses will then be dropped
	 * immediately. This is mostly useful in applications that only provide services with no (remote) control point functionality.
	 * </p>
	 * <p>
	 * Note that a discovered service type with version 2 or 3 will match an exclusive service type with version 1. UPnP services are required to be backwards
	 * compatible, version 2 is a superset of version 1, and version 3 is a superset of version 2, etc.
	 * </p>
	 * 
	 * @return An array of service types that are exclusively discovered, no other service will be discovered. A <code>null</code> return value will disable
	 *         discovery! An empty array means all services will be discovered.
	 */
