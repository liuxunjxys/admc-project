 ...
 * <p>
 * Uses the {@link org.teleal.cling.model.ServiceManager} to read the initial state of the {@link org.teleal.cling.model.meta.LocalService} on instantation.
 * Typically, the {@link #registerOnService()} method is called next, and from this point forward all
 * {@link org.teleal.cling.model.ServiceManager#EVENTED_STATE_VARIABLES} property change events are detected by this subscription. After moderation of state
 * variable values (frequency and range of changes), the {@link #eventReceived()} method is called. Delivery of the event message to the subscriber is not part
 * of this class, but the implementor of {@link #eventReceived()}.
 * </p>
 * 
...
public abstract class LocalGENASubscription extends GENASubscription<LocalService> implements PropertyChangeListener {
	...
	/**
	 * Moderates {@link org.teleal.cling.model.ServiceManager#EVENTED_STATE_VARIABLES} events and state variable values, calls {@link #eventReceived()}.
	 */
	...
	synchronized public void setSubscriptionDuration(Integer requestedDurationSeconds) {
		this.requestedDurationSeconds = requestedDurationSeconds == null ? Constants.DEFAULT_SUBSCRIPTION_DURATION_SECONDS : requestedDurationSeconds;
