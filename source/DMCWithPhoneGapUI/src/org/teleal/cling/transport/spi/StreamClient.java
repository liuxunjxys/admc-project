 ...
 * 
 * <p>
 * An implementation has to be thread-safe. Its constructor may throw {@link org.teleal.cling.transport.spi.InitializationException}.
 * </p>
 * 
 * @param <C>
 *            The type of the service's configuration.
 * 
...
public interface StreamClient<C extends StreamClientConfiguration> {
	 ...
	 * <p>
	 * This method will always try to complete execution without throwing an exception. It will return <code>null</code> if an error occurs, and optionally log
	 * any exception messages.
	 * </p>
	 * <p>
	 * This method <strong>is required</strong> to add a <code>Host</code> HTTP header to the outgoing HTTP request, even if the given
