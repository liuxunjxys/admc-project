...
public class DevicesPlugin extends Plugin implements UpnpProcessorListener {
	...
	private String createDMS(Device device) {
		...
		return "\"<a " + " class='dms_listitem' style='padding-bottom: 0px; padding-top: 0px; padding-left: 5px;'>" + "<table>" + "<tr class='tr_itemcontent'>"
				+ "<td class='td_listitem_left'>" + "<img class='img_imgoflistitem' alt='Server image' src='" + deviceImage + "'/>" + "</td>"
				+ "<td class='td_listitem_middle'>" + "<h5>" + device.getDetails().getFriendlyName() + "</h5>" + "<p>" + deviceAddress + "</p>" + "</td>"
				+ "</tr>" + "</table></a>\"";
	}
